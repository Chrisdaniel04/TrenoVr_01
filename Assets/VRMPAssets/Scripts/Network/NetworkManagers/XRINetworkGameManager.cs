...
namespace XRMultiplayer
{
    ...
    public class XRINetworkGameManager : MonoBehaviour
    {
        ...
        //TrainGameController initializer
...
# endif
        ...
        {
            playerCount = Mathf.Clamp(playerCount, 2, 32);
            Utils.Log($"{k_DebugPrepend}Creating New Lobby: {roomName}. maxPlayers={playerCount}");
        ...
        public void StartNetcodeIfNeeded()
        {
            if (NetworkManager.Singleton == null) return;
            if (NetworkManager.Singleton.IsListening) return;

       
            bool isSessionHost = sessionManager.currentSession != null && sessionManager.currentSession.IsHost;
        ...
        {
            trainGameController.ApplyStateNetworked();
        }
